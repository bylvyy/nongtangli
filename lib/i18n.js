...
const dict = {
  zh: {
    ...
    "rating.title": "走过这条路线了吗？",
    "rating.subtitle": "给我们打个分，帮我们做得更好",
    "rating.aria": "{n} 星",
    "rating.commentPlaceholder": "想说点什么？(可选)",
    "rating.submit": "提交",
  ...
  en: {
    ...
    "rating.title": "Walked this route?",
    "rating.subtitle": "Rate it to help us do better.",
    "rating.aria": "{n} stars",
    "rating.commentPlaceholder": "Anything to share? (optional)",
