...
const dict = {
  zh: {
    ...
    "nav.option.googleMaps.sub": "中国大陆需要 VPN",
    "nav.option.amapApp.label": "高德地图 App",
    "nav.option.amapApp.sub": "需已安装 · 国内体验最好",
  ...
  en: {
    ...
    "nav.option.googleMaps.label": "Google Maps",
    "nav.option.googleMaps.sub": "Needs VPN inside mainland China",
    "nav.option.amapApp.label": "AMap (Gaode) app",
    "nav.option.amapApp.sub": "If installed — best in mainland China",
