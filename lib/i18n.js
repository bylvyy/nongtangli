...
const dict = {
  zh: {
    ...
    "walking.next": "下一站",
    "walking.done": "看完了",
    "walking.complete.title": "走完啦",
    "walking.complete.subtitle": "标记这条路线为已走过?",
    "walking.complete.confirm": "标记",
  ...
  en: {
    ...
    "walking.complete.title": "Route done",
    "walking.complete.subtitle": "Mark this route as walked?",
    "walking.complete.confirm": "Mark",
