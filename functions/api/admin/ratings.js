...
//   ?route_id=xxx      → list ratings for one route, newest first
//   (no params)        → aggregated per-route summary
//                        [{ routeId, count, avg, lastAt }, ...]

import { json, serverError } from '../../_lib/db.js';
